...
const Errors = require("../api/errors/number02-main-error.js");
...
const logger = LoggerFactory.get("Number02MainAbl");

class Number02MainAbl {
  constructor() {
...
module.exports = new Number02MainAbl();
